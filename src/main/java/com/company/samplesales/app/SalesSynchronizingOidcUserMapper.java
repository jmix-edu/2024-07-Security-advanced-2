...
public class SalesSynchronizingOidcUserMapper extends SynchronizingOidcUserMapper<User> {
    ...
    public SalesSynchronizingOidcUserMapper(UnconstrainedDataManager dataManager, UserRepository userRepository, ClaimsRolesMapper claimsRolesMapper, RoleGrantedAuthorityUtils roleGrantedAuthorityUtils) {
